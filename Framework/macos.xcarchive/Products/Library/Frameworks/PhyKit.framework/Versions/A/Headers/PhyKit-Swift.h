...
SWIFT_CLASS("_TtC6PhyKit21PHYKinematicCharacter")
@interface PHYKinematicCharacter : CPHYKinematicCharacterController
- (nonnull instancetype)initWithEntity:(CPHYRigidBody * _Nonnull)rigidBody shapeRadius:(float)radius shapeHeight:(float)height stepHeight:(float)stepHeight world:(CPHYWorld * _Nonnull)world SWIFT_UNAVAILABLE;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
